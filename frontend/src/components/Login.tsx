...
export const Login: React.FC<AuthProps> = ({ onSuccess, onNavigate }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg =
        (typeof envelopeMsg === "string" ? envelopeMsg : null) ||
    ...
    <div className="min-h-[calc(100vh-120px)] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm p-6 sm:p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-xl font-sans">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-xs text-slate-400">Sign in to your PolicyLens account</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-slate-100 text-xs placeholder-slate-500 focus-visible:ring-2 focus-visible:ring-indigo-400 transition-colors"
              />
            </div>
          </div>
